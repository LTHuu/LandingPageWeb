        ...
        <div className="heroSection w-full pt-10 flex justify-center">
            <div className="topSection flex justify-center items-center">
                <div className="ProductInfo flex-2 flex-col items-center">
                    ...
                    <h2 className="proShort TextColor">Theo dõi nhịp tim và chất lượng giấc ngủ của bạn.</h2>
                    <h2 className="proShort TextColor">Giám sát hoạt động hàng ngày mọi lúc, mọi nơi.</h2>
                    </div>
                    <div className="flex">
                        ...
                        <button title="Mua ngay!" className="BuyButton"> Buy now! </button>
                    </div>
